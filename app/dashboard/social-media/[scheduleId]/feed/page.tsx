...
export default function FeedSimulatorPage() {
  ...
  const fetchRealFeed = useCallback(async () => {
    ...
    try {
      ...
      // 403 de plano → modal de upgrade, sem toast genérico
  ...
  return (
    <div className="min-h-screen bg-background/50">
      <Header />
      <main className={ownerAllowed ? "container mx-auto max-w-5xl py-8 px-4" : "container mx-auto max-w-lg py-10 px-4 space-y-4"}>
