...
export default function EquipmentDetailsPage() {
  ...
  const fetchEquipment = async () => {
    setLoading(true)
    try {
      console.log("[v0] Fetching equipment data for id:", equipmentId)
      ...
      if (equipSnap.exists()) {
        ...
        setEquipment({
          id: equipSnap.id,
          name: equipData.name || equipData.title,
          category: equipData.category,
          negotiationType: equipData.negotiationType,
          condition: equipData.condition,
          description: equipData.description,
          brand: equipData.brand,
          model: equipData.model,
          price: equipData.price,
          rentPeriod: equipData.rentPeriod,
          city: equipData.city,
          state: equipData.state,
          imageUrl: equipData.imageUrl,
          images: equipData.images || [],
          ownerId: equipData.ownerId,
          ownerName: equipData.ownerName,
          ownerPhone: equipData.ownerPhone,
          available: equipData.available !== false,
          additionalConditions: equipData.additionalConditions,
        })
      }
    } catch (error) {
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Actions */}
              {user && user.uid !== equipment.ownerId && equipment.available && (
