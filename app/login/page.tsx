...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    setError("");
    setLoading(true);
    trackEvent({ action: "login", category: "Auth", label: "Google Button Click" });
            ...
            <ScrollReveal direction="left">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-tight">
                  <span className="text-foreground">Conecte-se ao </span>
                  <br />
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                  Acesse sua conta e descubra oportunidades ilimitadas.
                  Gerencie projetos, alugue equipamentos e expanda sua rede.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="space-y-6">
              <ScrollReveal direction="left" delay={0.2}>
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground">Portfólio Profissional</h3>
                    <p className="text-sm text-muted-foreground">Mostre seu trabalho e conquiste clientes</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal direction="left" delay={0.3}>
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground">Rede de Profissionais</h3>
                    <p className="text-sm text-muted-foreground">Conecte-se com talentos de todo o Brasil</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal direction="left" delay={0.4}>
                <div className="flex items-center gap-4 group">
                  <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-pink-500 to-pink-600 flex items-center justify-center shadow-lg shadow-pink-500/20 group-hover:scale-110 transition-transform">
                    <Zap className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-foreground">Oportunidades Reais</h3>
                    <p className="text-sm text-muted-foreground">Acesse jobs e projetos exclusivos</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
                ...
                <CardHeader className="space-y-4 text-center pt-10 pb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base text-muted-foreground px-4">
                      Entre com sua conta para continuar sua jornada criativa
                    </CardDescription>
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-8 px-8 pb-10">
                  ...
                  <div className="text-center pt-2">
                    <p className="text-sm text-muted-foreground italic">
                      "Acesse a maior plataforma de talentos visuais do Brasil"
                    </p>
                  </div>
                </CardContent>
              </Card>
