...
function CalendarDayButton({
  ...
  const isRangeDate = modifiers.range_start || modifiers.range_end || modifiers.range_middle
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'border-2 border-primary bg-accent text-accent-foreground hover:bg-accent/80',
